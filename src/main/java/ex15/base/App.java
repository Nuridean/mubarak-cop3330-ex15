...
public class App {
    public static void main(String[] args){
        ...
        String correctName = "No0bkiller69";
        String correctPass = "abc$123";

        System.out.print("What is the username? ");
        String userAttempt = in.nextLine();

        if(userAttempt.equals(correctName)) {
            System.out.print("Please enter your password, No0bkiller69\n");
            String passAttempt = in.nextLine();

            if(passAttempt.equals(correctPass)){
